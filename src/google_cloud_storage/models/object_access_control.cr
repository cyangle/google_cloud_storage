...
module GoogleCloudStorage
  ...
  class ObjectAccessControl
    ...
    @[JSON::Field(key: "kind", type: String?, default: "storage#objectAccessControl", presence: true, ignore_serialize: kind.nil? && !kind_present?, emit_null: true)]
    property kind : String?
    @[JSON::Field(ignore: true)]
    property? kind_present : Bool = false

    # The name of the object, if applied to an object.
    @[JSON::Field(key: "object", type: String?, presence: true, ignore_serialize: object.nil? && !object_present?, emit_null: true)]
    ...
    def hash
      [bucket, domain, email, entity, entity_id, etag, generation, id, kind, object, project_team, role, self_link].hash
    end
