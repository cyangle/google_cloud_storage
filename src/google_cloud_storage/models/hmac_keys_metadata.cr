...
module GoogleCloudStorage
  ...
  class HmacKeysMetadata
    ...
    # Optional properties
    # The list of items.
    @[JSON::Field(key: "items", type: Array(HmacKeyMetadata)?, presence: true, ignore_serialize: items.nil? && !items_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "kind", type: String?, default: "storage#hmacKeysMetadata", presence: true, ignore_serialize: kind.nil? && !kind_present?, emit_null: true)]
