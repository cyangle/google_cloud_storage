...
module GoogleCloudStorage
  ...
  class BucketIamConfiguration
    ...
    # Optional properties
    @[NASON::Field(key: "bucketPolicyOnly", type: BucketIamConfigurationBucketPolicyOnly?, nillable: true)]
    ...
    @[NASON::Field(key: "publicAccessPrevention", type: String?, nillable: true)]
    property public_access_prevention : String?

    @[NASON::Field(key: "uniformBucketLevelAccess", type: BucketIamConfigurationUniformBucketLevelAccess?, nillable: true)]
    ...
    def hash
      [bucket_policy_only, public_access_prevention, uniform_bucket_level_access].hash
    end
