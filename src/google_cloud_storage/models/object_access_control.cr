...
module GoogleCloudStorage
  ...
  class ObjectAccessControl
    ...
    property kind : String? = "storage#objectAccessControl"
    ...
    def_equals_and_hash(@bucket, @bucket_present, @domain, @domain_present, @email, @email_present, @entity, @entity_present, @entity_id, @entity_id_present, @etag, @etag_present, @generation, @generation_present, @id, @id_present, @kind, @kind_present, @object, @object_present, @project_team, @project_team_present, @role, @role_present, @self_link, @self_link_present)
  end
end
