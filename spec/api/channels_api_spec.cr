...
# Unit tests for GoogleCloudStorage::ChannelsApi
...
describe "ChannelsApi" do
  describe "test an instance of ChannelsApi" do
    it "should create an instance of ChannelsApi" do
      api_instance = GoogleCloudStorage::ChannelsApi.new
      api_instance.should be_a(GoogleCloudStorage::ChannelsApi)
    end
  end

  # unit tests for storage_channels_stop
  ...
  # @return [nil]
  describe "storage_channels_stop test" do
    it "should work" do
