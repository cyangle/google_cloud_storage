...
module GoogleCloudStorage
  class PolicyBindingsInner
    ...
    # Optional properties
    @[JSON::Field(key: "condition", type: Expr?, presence: true, ignore_serialize: condition.nil? && !condition_present?, emit_null: true)]
    ...
    @[JSON::Field(key: "members", type: Array(String)?, presence: true, ignore_serialize: members.nil? && !members_present?, emit_null: true)]
