...
module GoogleCloudStorage
  class DefaultObjectAccessControlsApi
    ...
    def build_api_request_for_delete(
      *,
      ...
      if client_side_validation?
        ...
        unless (_alt = alt).nil?
          OpenApi::EnumValidator.validate("alt", _alt, STORAGE_DEFAULT_OBJECT_ACCESS_CONTROLS_DELETE_VALID_VALUES_FOR_ALT)
        end
    ...
    def build_api_request_for_get(
      *,
      ...
      if client_side_validation?
        ...
        unless (_alt = alt).nil?
          OpenApi::EnumValidator.validate("alt", _alt, STORAGE_DEFAULT_OBJECT_ACCESS_CONTROLS_GET_VALID_VALUES_FOR_ALT)
        end
        unless (_fields = fields).nil?
        end
        unless (_key = key).nil?
    ...
    def build_api_request_for_insert(
      *,
      ...
      if client_side_validation?
        ...
        unless (_alt = alt).nil?
          OpenApi::EnumValidator.validate("alt", _alt, STORAGE_DEFAULT_OBJECT_ACCESS_CONTROLS_INSERT_VALID_VALUES_FOR_ALT)
        end
        unless (_fields = fields).nil?
        end
        unless (_key = key).nil?
    ...
    # @optional @param upload_type [String?] Upload protocol for media (e.g. \"media\", \"multipart\", \"resumable\").
    # @optional @param user_ip [String?] Deprecated. Please use quotaUser instead.
    # @optional @param if_metageneration_match [String?] If present, only return default ACL listing if the bucket's current metageneration matches this value.
    # @optional @param if_metageneration_not_match [String?] If present, only return default ACL listing if the bucket's current metageneration does not match the given value.
    # @optional @param user_project [String?] The project to be billed for this request. Required for Requester Pays buckets.
    ...
    def build_api_request_for_list(
      *,
      ...
      if client_side_validation?
        ...
        unless (_alt = alt).nil?
          OpenApi::EnumValidator.validate("alt", _alt, STORAGE_DEFAULT_OBJECT_ACCESS_CONTROLS_LIST_VALID_VALUES_FOR_ALT)
        end
        unless (_fields = fields).nil?
        end
        unless (_key = key).nil?
    ...
    def build_api_request_for_patch(
      *,
      ...
      if client_side_validation?
        ...
        unless (_alt = alt).nil?
          OpenApi::EnumValidator.validate("alt", _alt, STORAGE_DEFAULT_OBJECT_ACCESS_CONTROLS_PATCH_VALID_VALUES_FOR_ALT)
        end
        unless (_fields = fields).nil?
        end
        unless (_key = key).nil?
    ...
    def build_api_request_for_update(
      *,
      ...
      if client_side_validation?
        ...
        unless (_alt = alt).nil?
          OpenApi::EnumValidator.validate("alt", _alt, STORAGE_DEFAULT_OBJECT_ACCESS_CONTROLS_UPDATE_VALID_VALUES_FOR_ALT)
        end
        unless (_fields = fields).nil?
        end
        unless (_key = key).nil?
