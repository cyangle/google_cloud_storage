...
module GoogleCloudStorage
  ...
  class BucketIamConfigurationUniformBucketLevelAccess
    ...
    @[JSON::Field(key: "lockedTime", type: Time?, default: nil, required: false, nullable: false, emit_null: false, converter: Time::RFC3339Converter)]
    getter locked_time : Time? = nil
    ...
    def list_invalid_properties : Array(String)
      ...
      unless (_locked_time = @locked_time).nil?
      end
      invalid_properties
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] locked_time Object to be assigned
    def locked_time=(new_value : Time?)
      unless new_value.nil?
      end

      @locked_time = new_value
    end
