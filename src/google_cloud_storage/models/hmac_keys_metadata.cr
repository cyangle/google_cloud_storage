...
module GoogleCloudStorage
  ...
  class HmacKeysMetadata
    ...
    # The list of items.
    @[JSON::Field(key: "items", type: Array(GoogleCloudStorage::HmacKeyMetadata)?, default: nil, required: false, nullable: false, emit_null: false)]
    getter items : Array(GoogleCloudStorage::HmacKeyMetadata)? = nil

    # The kind of item this is. For lists of hmacKeys, this is always storage#hmacKeysMetadata.
    @[JSON::Field(key: "kind", type: String?, default: "storage#hmacKeysMetadata", required: false, nullable: false, emit_null: false)]
    getter kind : String? = "storage#hmacKeysMetadata"
    ...
    def initialize(
      *,
      # Optional properties
      @items : Array(GoogleCloudStorage::HmacKeyMetadata)? = nil,
    ...
    def items=(new_value : Array(GoogleCloudStorage::HmacKeyMetadata)?)
