...
module GoogleCloudStorage
  class ComposeRequestSourceObjects
    ...
    @[NASON::Field(key: "objectPreconditions", type: ComposeRequestObjectPreconditions?, nillable: true)]
    property object_preconditions : ComposeRequestObjectPreconditions?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(*, @generation : String? = nil, @name : String? = nil, @object_preconditions : ComposeRequestObjectPreconditions? = nil)
    end
