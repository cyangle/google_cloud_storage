...
module GoogleCloudStorage
  ...
  class BucketWebsite
    ...
    @[JSON::Field(key: "mainPageSuffix", type: String?, presence: true, ignore_serialize: main_page_suffix.nil? && !main_page_suffix_present?, emit_null: true)]
    property main_page_suffix : String?
    @[JSON::Field(ignore: true)]
    property? main_page_suffix_present : Bool = false

    # If the requested object path is missing, and any mainPageSuffix object is missing, if applicable, the service will return the named object from this bucket as the content for a 404 Not Found result.
    @[JSON::Field(key: "notFoundPage", type: String?, presence: true, ignore_serialize: not_found_page.nil? && !not_found_page_present?, emit_null: true)]
    ...
    def hash
      [main_page_suffix, not_found_page].hash
    end
